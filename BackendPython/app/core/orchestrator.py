...
class RecommendationOrchestrator:
    ...
    def process_query(
        ...
        if not conversation_state.get("has_category"):
            ...
            conversation_state["category"] = intent_result["category"]
        
        # ===== STEP 2: ATTRIBUTE EXTRACTION =====
        if not conversation_state.get("extracted"):
            ...
            conversation_state["missing_required"] = extract_result["missing_required"]
